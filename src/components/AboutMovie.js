...
class AboutMovie extends Component {
    constructor () {
        super ()
        this.state = {favoriteMovies: [], isFavorite: false, isError: false, errorMessage: ""}
    }
   ...
   componentDidMount = () => {
    ...
    .then((response) => {
        ...
        return response.json()
            ...
            this.setState({favoriteMovies: [], isFavorite: false, isError: true, errorMessage: response.statusText})
        throw Error(response.statusText)
        }
    })
    .then((response) => {
        this.setState({favoriteMovies: response.favorites, isFavorite: false, isError: false, errorMessage: ""})
    })
    .then(() => {
   ...
   render() {
       return (
           <div className='about-movie'>
               ...
               <button className='favorite-button' disabled>In Your Favorites!</button>
               }
               {!this.state.isFavorite && 
